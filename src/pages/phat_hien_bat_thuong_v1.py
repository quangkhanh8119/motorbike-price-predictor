...
def phat_hien_xe_bat_thuong(df, models):    
    ...
    with st.container(border=True):
        ...
        kiem_tra_bat_thuong = st.button(f"🔍 **Kiểm tra bất thường**")
    ...
    if kiem_tra_bat_thuong:
        ...
        # Dò tìm bất thường    
        ketqua = detect_anomaly(model, input_xe)
        ...
        with col1_kq:            
            ...
            ui.colored_text(f"Lệch giá: **{ketqua['residual']:,.0f} VND / {lech_gia:.1f}%**", color="#f54242", size="20px", bold=False)
